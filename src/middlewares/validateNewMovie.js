...
module.exports = [
    ...
    check('CalificacionBlockbuster')    .isLength({min: 1, max: 5}).withMessage('Debes completar la Calificacion Blockbuster, con un valor del 0 al 10')
                                        .isDecimal().withMessage('Debe ser un decimal valido (9.5)'),
    check('CalificacionIMDb')           .isLength({min: 1, max: 5}).withMessage('Debes completar la Calificacion IMDb, con un valor del 0 al 10').isDecimal().withMessage('Debe ser un decimal valido (9.5)'),
    check('CalificacionRottenTomatoes') .isLength({min: 1, max: 5}).withMessage('Debes completar la Calificacion Rotten Tomatoes, con un valor del 0 al 10').isDecimal().withMessage('Debe ser un decimal valido (9.5)'),
    ...
    check('movieUrl')                    .isLength({ max: 300}).withMessage('Debes completar con una url valida'),
